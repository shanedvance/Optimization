                            ...
                            unsigned int i, int np, int strategy)
        {
            ...
            switch (strategy)
            {
                ...
                case 3:
                {
                    ...
                    do
                    {
                        u->at(j) = x.at(i).particle.at(j) + F * (x_best.at(j) - x.at(i).particle.at(j))
                                  + F * (x.at(r1).particle.at(j) - x.at(r2).particle.at(j));
                        j = (j + 1) % this->dim;
                        ++l;
                    }
                    while(this->random(Range(0.0, 1.0)) < cr && l < this->dim);
                ...
                case 4:
                {
                    ...
                    do
                    {
                        u->at(j) = x_best.at(j) + F * (x.at(r1).particle.at(j) + x.at(r2).particle.at(j)
                                                      - x.at(r3).particle.at(j) - x.at(r4).particle.at(j));
                        j = (j + 1) % this->dim;
                        ++l;
                    }
                    while(this->random(Range(0.0, 1.0)) < cr && l < this->dim);
                ...
                case 5:
                {
                    ...
                    do
                    {
                        u->at(j) = x.at(r5).particle.at(j) + F * (x.at(r1).particle.at(j) + x.at(r2).particle.at(j)
                                                               - x.at(r3).particle.at(j) - x.at(r4).particle.at(j));
                        j = (j + 1) % this->dim;
                        ++l;
                    }
                ...
                case 7:
                {
                    ...
                    for (unsigned int j = 0; j < this->dim; ++j)
                    {
                        if (this->random(Range(0.0, 1.0)) < cr || j == j_rand)
                        {
                            u->at(j) = x.at(r3).particle.at(j) + F * (x.at(r1).particle.at(j)
                                    - x.at(r2).particle.at(j));
                        }
                    }
                    break;
                }
